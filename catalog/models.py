...
class Language(models.Model):
    name = models.CharField(max_length=30, unique=True, help_text="Language of the book")
...
class Book(models.Model):
    ...
    language = models.ManyToManyField(Language, help_text="Select languages for the book")
